...
public class FlowQueue {
    ...
    public FlowQueue() {
        ...
        queues.add(LOW,new LinkedBlockingQueue<DatagramPacket>());
        queues.add(DEF,new LinkedBlockingQueue<DatagramPacket>());
        queues.add(IMP,new LinkedBlockingQueue<DatagramPacket>());
        queues.add(CRI,new LinkedBlockingQueue<DatagramPacket>());
